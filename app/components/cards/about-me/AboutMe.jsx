...
const aboutMeBrief = `I am a developer in NYC who loves solving creative challenges...`; // , a lover of sound synthesis, and occasional electronic-musician... I am a developer with an eye for design and an ear for music. 
const aboutMeLong = `I am a developer in NYC who loves solving creative challenges. I came from a background in audio engineering and sound design. Now I enjoy discovering experimental methods of utilizing music through computer code.`;
